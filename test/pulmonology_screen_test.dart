...
void main() {
  ...
  testWidgets('PulmonologyScreen renders with default list', (WidgetTester tester) async {
    when(mockMedicalPlacesService.fetchFacilities(queryType: 'pulmonology')).thenAnswer((_) async => mockData);
  ...
  testWidgets('Search functionality filters the list', (WidgetTester tester) async {
    when(mockMedicalPlacesService.fetchFacilities(queryType: 'pulmonology', searchQuery: 'Hospital', searchType: 'name')).thenAnswer((_) async => [mockData[1]]);
