...
void main() {
  ...
  testWidgets('PhysiotherapyScreen renders with default list', (WidgetTester tester) async {
    when(mockMedicalPlacesService.fetchFacilities(queryType: 'physiotherapy')).thenAnswer((_) async => mockData);
  ...
  testWidgets('Search functionality filters the list', (WidgetTester tester) async {
    when(mockMedicalPlacesService.fetchFacilities(queryType: 'physiotherapy', searchQuery: 'Rehab', searchType: 'name')).thenAnswer((_) async => [mockData[1]]);
