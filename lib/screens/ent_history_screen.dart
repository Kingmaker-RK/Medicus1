...
import '../models/ent_record_model.dart';
import '../constants/colors.dart';
import '../widgets/translated_widget.dart';
import 'package:intl/intl.dart';

class ENTHistoryScreen extends StatefulWidget {
  const ENTHistoryScreen({Key? key}) : super(key: key);

  @override
  State<ENTHistoryScreen> createState() => _ENTHistoryScreenState();
}

class _ENTHistoryScreenState extends State<ENTHistoryScreen> {
  final List<ENTRecord> _records = [];
    ...
    setState(() {
      ...
      _records.insert(
        ...
        ENTRecord(
          ...
          fileName: 'ENT_Report_${DateFormat('MM_dd').format(now)}',
          timestamp: now,
  ...
  void _renameRecord(ENTRecord record, String newName) {
    setState(() {
      record.fileName = newName;
    });
  }

  void _showRenameDialog(ENTRecord record) {
  ...
  void _downloadRecord(ENTRecord record) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('ENT History'),
