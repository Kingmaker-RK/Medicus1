...
import '../models/chiropractic_record_model.dart';
import '../constants/colors.dart';
import '../widgets/translated_widget.dart';
import 'package:intl/intl.dart';

class ChiropracticHistoryScreen extends StatefulWidget {
  const ChiropracticHistoryScreen({Key? key}) : super(key: key);

  @override
  State<ChiropracticHistoryScreen> createState() => _ChiropracticHistoryScreenState();
}

class _ChiropracticHistoryScreenState extends State<ChiropracticHistoryScreen> {
  // Mock data source
  final List<ChiropracticRecord> _records = [];
    ...
    setState(() {
      ...
      _records.insert(
        ...
        ChiropracticRecord(
          ...
          fileName: 'Chiro_Report_${DateFormat('MM_dd').format(now)}',
          timestamp: now,
  ...
  void _renameRecord(ChiropracticRecord record, String newName) {
    setState(() {
      record.fileName = newName;
    });
  }

  void _showRenameDialog(ChiropracticRecord record) {
  ...
  void _downloadRecord(ChiropracticRecord record) {
    // Simulate download
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('Chiropractic History'),
