...
import '../models/physiotherapy_record_model.dart';
import '../constants/colors.dart';
import '../widgets/translated_widget.dart';
import 'package:intl/intl.dart';

class PhysiotherapyHistoryScreen extends StatefulWidget {
  const PhysiotherapyHistoryScreen({Key? key}) : super(key: key);

  @override
  State<PhysiotherapyHistoryScreen> createState() => _PhysiotherapyHistoryScreenState();
}

class _PhysiotherapyHistoryScreenState extends State<PhysiotherapyHistoryScreen> {
  // Mock data source
  final List<PhysiotherapyRecord> _records = [];
    ...
    setState(() {
      ...
      _records.insert(
        ...
        PhysiotherapyRecord(
          ...
          fileName: 'Physio_Report_${DateFormat('MM_dd').format(now)}',
          timestamp: now,
  ...
  void _renameRecord(PhysiotherapyRecord record, String newName) {
    setState(() {
      record.fileName = newName;
    });
  }

  void _showRenameDialog(PhysiotherapyRecord record) {
  ...
  void _downloadRecord(PhysiotherapyRecord record) {
    // Simulate download
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('Physiotherapy History'),
