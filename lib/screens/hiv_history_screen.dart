...
import '../models/hiv_record_model.dart';
import '../constants/colors.dart';
import '../widgets/translated_widget.dart';
import 'package:intl/intl.dart';

class HIVHistoryScreen extends StatefulWidget {
  const HIVHistoryScreen({Key? key}) : super(key: key);

  @override
  State<HIVHistoryScreen> createState() => _HIVHistoryScreenState();
}

class _HIVHistoryScreenState extends State<HIVHistoryScreen> {
  final List<HIVRecord> _records = [];
    ...
    setState(() {
      ...
      _records.insert(
        ...
        HIVRecord(
          ...
          fileName: 'HIV_Report_${DateFormat('MM_dd').format(now)}',
          timestamp: now,
  ...
  void _renameRecord(HIVRecord record, String newName) {
    setState(() {
      record.fileName = newName;
    });
  }

  void _showRenameDialog(HIVRecord record) {
  ...
  void _downloadRecord(HIVRecord record) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('My Reports & History'),
