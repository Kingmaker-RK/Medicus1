...
class TranslationScreenNew extends StatefulWidget {
  const TranslationScreenNew({Key? key}) : super(key: key);

  @override
  State<TranslationScreenNew> createState() => _TranslationScreenNewState();
}

class _TranslationScreenNewState extends State<TranslationScreenNew>
