...
import '../models/eye_care_record_model.dart';
import '../constants/colors.dart';
import '../widgets/translated_widget.dart';
import '../widgets/upload_selector.dart';
import 'package:intl/intl.dart';

class EyeCareHistoryScreen extends StatefulWidget {
  const EyeCareHistoryScreen({Key? key}) : super(key: key);

  @override
  State<EyeCareHistoryScreen> createState() => _EyeCareHistoryScreenState();
}

class _EyeCareHistoryScreenState extends State<EyeCareHistoryScreen> {
  final List<EyeCareRecord> _records = [];
    ...
    setState(() {
      ...
      _records.insert(
        ...
        EyeCareRecord(
          ...
          fileName: 'Eye_Checkup_Report_${DateFormat('MM_dd').format(now)}',
          timestamp: now,
          filePath: filePath,
        ),
      );
  ...
  void _renameRecord(EyeCareRecord record, String newName) {
    setState(() {
      record.fileName = newName;
    });
  }

  void _showRenameDialog(EyeCareRecord record) {
  ...
  void _downloadRecord(EyeCareRecord record) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('Eye Care History'),
