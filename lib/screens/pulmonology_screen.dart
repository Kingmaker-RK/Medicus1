...
class _PulmonologyScreenState extends State<PulmonologyScreen> with SingleTickerProviderStateMixin {
  ...
  void _showRenameDialog(PulmonologyRecord record) {
  ...
  void _downloadRecord(PulmonologyRecord record) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const AutoTranslateText('Pulmonology'),
