class AppConstants {
  ...
  static const List<Map<String, String>> supportedLanguages = [
    ...
    // Indian Languages (All 22 Scheduled Languages + Regional Languages)
    ...
    {'code': 'kn', 'name': 'Kongo', 'nativeName': 'Kikongo'},
    ...
    {'code': 'ny', 'name': 'Nyanja', 'nativeName': 'ChiCheŵa'},
    {'code': 'iw', 'name': 'Hebrew (Old)', 'nativeName': 'עברית'},
    {'code': 'jw', 'name': 'Javanese (Old)', 'nativeName': 'Basa Jawa'},
    ...
    {'code': 'bak', 'name': 'Bashkir', 'nativeName': 'Башҡортса'},
    ...
    {'code': 'sgn', 'name': 'Sign Language', 'nativeName': 'Sign Language'},
