...
abstract class AppLocalizations {
  ...
  /// The main welcome title on the landing screen
  ///
  ...
  /// Checkbox label for remembering user
  ///
  /// In en, this message translates to:
  /// **'Remember me'**
  ...
  /// Checkbox label for agreeing to terms
  ///
  /// In en, this message translates to:
  /// **'I agree to the Terms & Conditions and Privacy Policy'**
  String get agreeToTerms;

  /// Error message when terms are not agreed to
  ///
  /// In en, this message translates to:
  ...
  /// Role selection option for Patient
  ///
  /// In en, this message translates to:
  /// **'Patient'**
  String get rolePatient;

  /// Role selection option for Doctor
  ///
  /// In en, this message translates to:
  /// **'Doctor'**
